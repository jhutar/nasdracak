# POV Architecture: Ohrozena vesnice

## POV Configuration
**Mode:** Single POV
**Reasoning:** The spec.md and plan.md clearly state the story is told from the first-person perspective of Paja (First-person limited). This aligns with the target audience (children 6+) and the goal of showing her internal growth from a stubborn, independent girl to someone who understands harmony with nature.
...
Even in a Single POV story, managing what the narrator knows vs. what the reader infers is critical.

| Secret / Revelation | Who knows it | When is it revealed to Paja | Reader's Knowledge |
|---|---|---|---|
...
The story will be drafted sequentially from Paja's perspective, following the 5-Act structure defined in plan.md.

## Continuity Constraints
- **Tense Consistency:** The story is written in the present tense. Do not slip into past tense unless recounting a specific memory.
- **Narrative Distance:** Close limited first-person. We only know what Paja sees, hears, feels, and thinks. We cannot jump into the heads of other characters (like Vratislav or the wolf). We only know their emotions through their external actions as interpreted by Paja.
- **Knowledge Fencing:** Paja cannot know Vratislav's inner thoughts or his master plan until Krivak confesses or she observes him directly. She cannot know Radmila's past until she sees her use the bow.
