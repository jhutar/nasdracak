---
chapter_id: T005
chapter_name: Vlci zleb a Dracek
pov_character: Paja
pov_type: Single POV (First-person limited)
act_phase: Act I
plot_structure_stage: Inciting Incident (Action)
...
## Opening Hook
Z pod kořenů vyvráceného dubu se ozývá zuřivé kvičení rozkročeného prasátka.
...
- **Rypáček:** Ukazuje svou věrnost a statečnost.
...
- Boj s krysami a léčení musí být popsány jako dějová scéna, bez bodů zdraví.
